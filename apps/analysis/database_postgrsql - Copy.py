...
def sqlite_connection(db_file):
    ...
    return conn
def postgesql_connection(db_file):
	import psycopg2
    """ create a database connection to the postgreslqe database
    """
	network_server="host='localhost' dbname='Block' user='postgres' password='Aa1234567#'"#connect to data base form my device
